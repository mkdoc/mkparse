...
module.exports = {
   ...
   *  lines.
   *  
   *  By default will match a space or a tab character once,
   *  depending upon your comment style you should adjust this so that 
   *  whitespace is preserved as intended.
   *
