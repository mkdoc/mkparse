...
function assert(comments) {
  ...
  expect(comments[0].tags[0].name).to.eql('spec.erl');
...
describe('cparse:', function() {
  ...
  it('should use erlang language', function(done) {
    var source = 'test/fixtures/lang/spec.erl'
      , stream = parse.load(source, {rules: require('../../../lang/erlang')})
      , comments = [];
