...
function assert(comments) {
  ...
  expect(comments[0].tags[0].name).to.eql('spec.sass');
...
describe('cparse:', function() {
  ...
  it('should use sass language', function(done) {
    var source = 'test/fixtures/lang/spec.sass'
      , stream = parse.load(source, {rules: require('../../../lang/sass')})
      , comments = [];
