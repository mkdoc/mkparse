...
function assert(comments) {
  ...
  expect(comments[0].tags[0].name).to.eql('spec.md');
...
describe('cparse:', function() {
  ...
  it('should use markdown language', function(done) {
    var source = 'test/fixtures/lang/spec.md'
      , stream = parse.load(source, {rules: require('../../../lang/markdown')})
      , comments = [];
