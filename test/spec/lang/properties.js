...
function assert(comments) {
  ...
  expect(comments[0].tags[0].name).to.eql('spec.properties');
...
describe('cparse:', function() {
  ...
  it('should use properties language', function(done) {
    var source = 'test/fixtures/lang/spec.properties'
      , stream = parse.load(
          source, {rules: require('../../../lang/properties')})
      , comments = [];
