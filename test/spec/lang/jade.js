...
function assert(comments) {
  ...
  expect(comments[0].tags[0].name).to.eql('spec.jade');
...
describe('cparse:', function() {
  ...
  it('should use jade language', function(done) {
    var source = 'test/fixtures/lang/spec.jade'
      , stream = parse.load(source, {rules: require('../../../lang/jade')})
      , comments = [];
